    ...
    <div>
      <form>
        <select className={classes.main_input} required>
          ...
          <option value="AS">Assam</option> <option value="BR">Bihar</option>{" "}
          <option value="CH">Chandigarh</option>{" "}
          <option value="CT">Chhattisgarh</option>{" "}
          <option value="DN">Dadra and Nagar Haveli</option>{" "}
          <option value="DD">Daman and Diu</option>{" "}
          <option value="DL">Delhi</option> <option value="GA">Goa</option>{" "}
          ...
          <option value="KL">Kerala</option> <option value="LA">Ladakh</option>{" "}
        ...
        >
          ...
          <option value="Una">Una</option> <option value="Unnao">Unnao</option>{" "}
